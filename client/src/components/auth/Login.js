		...
		if (this.state.redirectTo) {
			...
			return (
				<div>
					...
					<body>
						<div
							data-layer="23ef2ffb-fb42-4230-9c9d-447f5ec8d48d"
							className="web19201"
						>
							<div
							...
							></div>
							<div
								data-layer="41f04f20-2e10-42fe-aae6-a515b153e6aa"
								className="x25694"
							>
								<div
									data-layer="993cd83b-9c73-4697-932f-6b2eb7ff0093"
									className="group1"
								>
									<svg
							...
							<form onSubmit={this.onSubmit}>
								...
								></div>
								<div
									data-layer="800ffc79-a596-4bcf-9a9a-1cea09f479ae"
									className="signUp"
								>
									Sign Up
								</div>
								...
								{/*** Remeber My Information ***/}

								<div
									data-layer="47e75b8b-080b-411d-a5b0-f5181a7d0ffe"
									className="group3"
								>
									<div>
										<input
								...
								<div
									data-layer="86760612-4f79-4d0e-b30c-b64c9cd97353"
									className="group2"
								>
									<button
								...
								<div
									data-layer="6646b79f-b68e-4013-817a-c97b2de52deb"
									className="group5"
								>
									{/* <label
                ...
                >
                  Email address
								...
								<div
									data-layer="c92f5ecd-87d5-4f67-a363-48251ee22040"
									className="group4"
								>
									<input
